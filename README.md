...
| Herramienta | Para qué | Dónde se consigue |
|---|---|---|
| Python 3.11 o superior | Lenguaje por defecto del curso | [python.org](https://www.python.org/downloads/) — marcar *Add to PATH* |
| R y RStudio | Cuatro sesiones del curso | [posit.co](https://posit.co/download/rstudio-desktop/) |
| Quarto | Informes y presentaciones | [quarto.org](https://quarto.org/docs/get-started/) |
| Git | Todo el curso | [git-scm.com](https://git-scm.com/downloads) |
| VS Code o RStudio | Editor | cualquiera de los dos |
